...
namespace Final_Project
{
    public partial class OrderViewForm : Form
    {
        ...
        private void LoadOrders()
        {
            ...
            string query = string.Format(@"SELECT * FROM View_UserOrder WHERE AddedBy = {0}", Global.UserInfo.UsertId);
            if (Global.UserInfo.Username == "Admin")
            {
                query = string.Format(@"SELECT * FROM View_UserOrder");//if admin then load all orders otherwise user wise orders load
            }
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            if (_orderId > 0)
            {
                ...
                userOrderDetails = this.GetOrderDetails(dataTable);
            ...
            foreach (var userOrderDetail in userOrderDetails)
            {
                ...
                lastPoint += rowGap;
                e.Graphics.DrawString(" Amount : " + userOrderDetail.UnitPrice * userOrderDetail.Qty, new Font("Arial", 14, FontStyle.Regular), Brushes.Black, new Point(120, lastPoint));
        ...
        public List<UserOrderDetail> GetOrderDetails(DataTable dt)
        {
