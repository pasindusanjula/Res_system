    ...
    public partial class UserOrderForm : Form
    {
        ...
        private void AddToCart()
        {
            ...
            else
            {
                ...
                if (orderTotalRows > 1)
                {
                    //var orderRow = orderGridView.Rows.Cast<DataGridViewRow>().Where(r => r.Cells["ItemId"].Value.ToString() == itemId.ToString()).First();
                    ...
                    try
                    {
                        ...
                        if (orderId > 0)
                        {
                            ...
                            for (int i = 0; i < orderGridView.Rows.Count - 1; i++)
                            {
                                ...
                                command.Parameters.AddWithValue("@Qty", orderDetail.Qty);//Login user id
